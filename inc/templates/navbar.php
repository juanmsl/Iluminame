...
<nav id="main-navbar" class="navbar"><a href="/"><img src="resources/images/icon.png" class="logo"/></a><a href="/" class="logo-title">Ilumíname</a>
  <form action="home.php" method="get" class="navbar-finder">
    <section class="main-bar">
      <div id="toggleOptions" target="#radio-options" class="toggle"><i class="icon-caret-down"></i></div><input type='search' name='search' placeholder='¿Buscas una materia, usuario o monitoria?' value='<?php if(isset($search)) echo clean($search); ?>' maxlength=60 class='search-bar'>
