    ...
    <div class="mainContent">
      <div class="user_information">
        <section class="user-picture-edit">
          ...
          <button class='full-button form-delete' onclick='javascript:delete_account()'>Eliminar cuenta</button>
        </section>
        <div class="forms-section">
          ...
          <form action='edit_account.php' method='post' class='edit-form' id='form-personal' enctype='multipart/form-data'>
          	...
          	<textarea name='aboutme' placeholder='Cuentanos un poco sobre ti, ¿que te gusta hacer?' class='edit-item' rows='3' maxlength='200'><?php echo clean($myrow["aboutme"]); ?></textarea>
          ...
          <form action='change_password.php' method='post' class='edit-form'>
          	<input type='password' name='old_password' placeholder='Contraseña actual' class='edit-item' minlength='6' maxlength='20' required>
          	<input type='password' name='new_password' placeholder='Contraseña nueva' class='edit-item' minlength='6' maxlength='20' required>
          	<input type='password' name='conf_new_password' placeholder='Contraseña nueva' class='edit-item' minlength='6' maxlength='20' required>
