...
dbquery("INSERT INTO notificaciones (descripcion, fecha, vista, estudiante_id_recibe, estudiante_id_envia) VALUES ('<b>" . filter($myrow["nombre"]) . "</b> se ha unido a tu monitoria de <b>" . filter($monitoria["materia"]) . "</b>', " . time() . ", '0', " . $monitoria["id_monitor"] . " , " . USER_ID . ")");
